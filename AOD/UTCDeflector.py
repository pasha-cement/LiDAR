...
class DevReader:
    def __init__(self, filename: str) -> None:
        self.__dev = pd.read_csv(filename)
        self.__angle_interpolator = interpolate.CubicSpline(self.__dev["Angle"], self.__dev["Frequency"])
        
    def get_freq_by_angle(self, angle: float) -> float:
        return self.__angle_interpolator(angle)
